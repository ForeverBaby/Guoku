    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Account.UserBean userBean = new Account.UserBean();
                userBean.setAuthorized_author(false);
                SearchUserBean.BeanBean beanBean = bean.get(position);
                userBean.setAvatar_large(beanBean.getAvatar_large());
                userBean.setAvatar_small(beanBean.getAvatar_small());
                userBean.setFollowing_count(beanBean.getFollowing_count());
                userBean.setEntity_note_count(beanBean.getEntity_note_count());
                userBean.setLike_count(beanBean.getLike_count());
                userBean.setRelation(beanBean.getRelation());
                userBean.setDig_count(beanBean.getDig_count());
                userBean.setUser_id(beanBean.getUser_id());
                userBean.setFan_count(beanBean.getFan_count());
                userBean.setNick(beanBean.getNick());
                userBean.setLocation(beanBean.getLocation());
                userBean.setEmail(beanBean.getEmail());
                userBean.setWebsite(beanBean.getWebsite());
                userBean.setBio(beanBean.getBio());
                userBean.setNickname(beanBean.getNickname());
                userBean.setTag_count(beanBean.getTag_count());
                userBean.setGender(beanBean.getGender());
                userBean.setMail_verified(true);
